...
Specific information regarding the sampling conditions for each plasticizer are included in the file: `SampleDetails.csv`. The raw and processed data are available at: https://data.nist.gov/od/id/mds2-3837.
